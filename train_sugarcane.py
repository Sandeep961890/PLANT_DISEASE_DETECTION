...
def main(dataset_dir: str, out_dir: str):
    ...
    print("\n===================================")
    print(" SUGARCANE DISEASE TRAINING ")
    print("===================================\n")
    ...
    model, le = train_and_save_svm(
        ...
        train_y,
        out_dir,
        model_name='sugarcane_svm_model'
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--dataset',
        default='dataset/sugarcane',
        help='Path to sugarcane dataset folder'
    )

    parser.add_argument(
        '--out',
        default='outputs/sugarcane',
